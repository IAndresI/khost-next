            ...
            <div className={styles.inner}>
              <div className={styles.buttonContainer}>
                ...
                <button 
                  ...
                  data-side="left"
                  onClick={() => setPlan("")}>Yearly</button>
                <button 
                  className={`${styles.button} ${plan === "yearly" ? styles.active : null}`}
                  data-side="right"
                  onClick={() => setPlan("yearly")}>Monthly</button>
              </div>
              <ul className={`${styles.list} list`}>
                <li className={`${styles.tarif} ${plan ? styles.yearly : ""}`}>
                ...
                <li className={`${styles.tarif} ${styles.startup} ${plan ? styles.yearly : ""}`}>
                ...
                <li className={`${styles.tarif} ${styles.popular} ${plan ? styles.yearly : ""}`}>

                  <div className={`${styles.face} ${styles.popular} ${styles.front}`}>
                    <div className={styles.spot}></div>
                ...
                <li className={`${styles.tarif} ${styles.premium} ${plan ? styles.yearly : ""}`}>
